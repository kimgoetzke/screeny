/**
 * Generates tests/fixtures/dedup.gif — a 3-frame 4×4 GIF:
 ...
 *
 * Used by E2E deduplication tests to assert that:
 *   - dedup-merge yields [red(300ms), blue(100ms)]
 *   - dedup-drop  yields [red(100ms), blue(100ms)]
 *
 * Run once to produce the binary fixture:
 *   node tests/fixtures/create-dedup-fixture.mjs
 */
...
// Frame 1: red, 200 ms  (adjacent duplicate)
...
const outPath = join(__dirname, "dedup.gif");
